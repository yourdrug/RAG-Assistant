...
import { useDeleteDocument, useDocuments } from "@/shared/api/hooks";
...
export function AdminDocumentsPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-2xl font-bold">Documents (Admin)</h1>
        <p className="text-muted-foreground">Full document management</p>
      </div>
      <Card>
