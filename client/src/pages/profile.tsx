    ...
    <div className="p-6 space-y-6 max-w-2xl">
      ...
      <Card>
        ...
        <CardContent>
          <code className="block rounded bg-muted px-3 py-2 text-sm font-mono break-all">
            {token ? `${token.substring(0, 50)}...` : "Not authenticated"}
          </code>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Requires backend endpoint (POST /auth/change-password)</CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-sm text-muted-foreground">
            Password change will be available once the backend provides the endpoint.
          </p>
        </CardContent>
      </Card>
    </div>
