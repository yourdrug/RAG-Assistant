...
import { useConversations, useCurrentUser } from "@/shared/api/hooks";
  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      {convPanelOpen && (
        <div
          ref={convPanelRef}
          className="hidden lg:flex flex-col w-72 shrink-0 border-r bg-sidebar"
        >
          ...
          <ScrollArea className="flex-1">
            <nav className="space-y-0.5 p-2">
              ...
              {convData?.conversations?.length === 0 && (
                <p className="px-3 py-4 text-xs text-center text-sidebar-foreground/40">
                  No dialogues yet
                </p>
              )}
            </nav>
                ...
                <div className="flex items-center gap-2 p-2">
                  <div className="flex flex-col space-y-1 leading-none">
                    ...
                    <p className="text-xs text-muted-foreground">
                      {displayUser?.role} · {displayUser?.kind}
                    </p>
                  </div>
                </div>
                <DropdownMenuSeparator />
